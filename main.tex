...
\DeclareCaptionFormat{center}{
    \centering #1#2\minipage[t]{\dimexpr0.7\linewidth}\raggedright #3\endminipage
}

\captionsetup[figure]{width=0.7\linewidth, format=center}
